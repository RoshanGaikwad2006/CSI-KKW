...
export const eventsData: EventItem[] = [
  {
    ...
    venueFull: "Online Google Meet / KKWIEER Campus Labs",
    description:
      "Join us for Vision Week 2026 — 5 Days of transformative masterclasses covering AI Tools & Workflows, Smart India Hackathon (SIH) guidance, Placement prep, GATE insights, and Soft Skills grooming by expert speakers and CSI KKWIEER.",
    image: "/images/cohort.jpg",
    attendees: null,
    expectedAttendees: "500+ Registered Students",
    featured: true,
    registrationClosed: false,
    tags: ["Vision Week", "AI", "Hackathon", "GATE", "Placements", "Flagship"],
    whatToExpect: [
      {
        title: "AI Tools & Workflows",
        desc: "Hands-on exposure to modern generative AI, developer tools & productivity workflows.",
        icon: "sessions",
      },
      {
        title: "SIH (Smart India Hackathon)",
        desc: "Problem statement analysis, ideation, team formation & winning hackathon strategy.",
        icon: "talks",
      },
      {
        title: "Placement & Career Guidance",
        desc: "Resume optimization, interview preparation, tech stacks & campus drive insights.",
        icon: "drive",
      },
      {
        title: "Official CSI Certificates",
        desc: "Verified activity e-certificates for all registered and attending students.",
        icon: "cert",
      },
    ],
  },
